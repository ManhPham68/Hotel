        ...
        <form action="{{route('Rooms.update',$room->id)}}" enctype="multipart/form-data" method="post">
            ...
            <div class="form-group">
                <div class="form-group">
                    ...
                    <p>
                        @foreach($room_image as $room_image)
                            <img style="width: 200px;height: 200px;margin-right: 20px" src="{{asset($room_image->image)}}">
                        @endforeach
                    </p>

                    <input class="form-control-file" type="file" name="image[]" multiple="multiple">
                </div>
            </div>
            ...
            <div class="form-group">
                <label>Address</label>
                <input type="text" name="address" class="form-control" required value="{{$room->address}}">
            </div>
